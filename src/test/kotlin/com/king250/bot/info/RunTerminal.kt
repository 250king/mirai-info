package com.king250.bot

import com.king250.bot.com.king250.bot.info.Plugin
...
suspend fun main() {
    ...
    pluginInstance.load() // 主动加载插件, Console 会调用 MiraiInfo.onLoad
    pluginInstance.enable() // 主动启用插件, Console 会调用 MiraiInfo.onEnable
